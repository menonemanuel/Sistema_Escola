...
private void inserir(){
        ...
        if (daoEstadoCivil.inserir(Integer.parseInt(GetId.getText()), tfNome.getText())){
     ...
     private void alterar(){
        ...
        if (daoEstadoCivil.alterar(Integer.parseInt(GetId.getText()), tfNome.getText())){
        ...
        if (daoEstadoCivil.excluir(Integer.parseInt(GetId.getText()))){
